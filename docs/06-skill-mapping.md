...
| 10 | **`/uipath-solution`** | Bundles the case, BPMN, RPA, API workflows, agents, coded app, and connectors into one deployable `.uipx` for staging.uipath.com / uipathlabs / Playground. | `../solution/solution.md`, `../solution/project-structure.md`, `../solution/deploy.md` *(planned)* | Cross-cutting (deployment) |
